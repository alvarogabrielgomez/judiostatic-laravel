                ...
                <div class="deal-info deal-white" style="padding: 0px; overflow: hidden;">
                  ...
                  <form @submit.prevent="formSubmit" id="insert-form">
                    ...
                    <div class="group-input">
                      <input class="input-material" id="clientfirst" type="text" name="client_first" required style="width:100%;max-width:285px;">
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label class="label-material">Nombre</label>
                    </div>
                    <div class="group-input">
                      <input class="input-material" id="clientlast" type="text" name="client_last" required style="width:100%;max-width:285px;">
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label class="label-material">Apellido</label>
                    </div>
                    <div class="group-input">
                      <input class="input-material" id="clientemail" type="email" name="email" required style="width:100%;max-width:285px;">
                      <span class="highlight"></span>
                      <span class="bar"></span>
...
<p> <i style="font-size: 1.5em;color: #7fbf4e;margin-right: 10px;" class="fas fa-check-circle"></i> Oi, {{this.$store.state.userdata.client_first + " " + this.$store.state.userdata.client_last}}!.</p>
                      ...
                      <div id = "qr" v-bind:style="{'backgroundImage': 'url(data:image/png;base64,'+this.qrcode+')'}">
                ...
                <div id="pwd-form-container">
                  <form @submit.prevent="formSubmit" id="pwd-form">
                    ...
                    <div v-if="hasPass == true" class="group-input" style="margin: auto;">
                      <input  class="input-material" id="clientpwd" type="password" name="password" required v-model="password" style="width:88%;max-width:285px;">
                      <span class="highlight"></span>
                      <span class="bar"></span>
                      <label class="label-material">Password</label>
                    </div>
                    <transition name="fade" mode="out-in">
                      <p style="top:44px;" class="alert alert-danger" v-if="hasError && hasPass" > {{responseContent}} </p>
                      <p style="top:44px;" class="alert alert-normal" v-if="hasResponse && hasPass" > {{responseContent}} </p>
                    </transition>

                    <div>
                      <p v-if="hasPass == false" style="margin-top: 0px;">
