                    ...
                    <div class="title-hero-deals">{{$posts->title}}</div>
                        ...
                        <div class="desc-art">
                            <p class="description-text">
                                    {!! __('messages.deals_def_msg', ['buss_name' => $posts->buss_name]) !!}<br></p>
                            <div class="buss-dir">
                            ...
                            <p></p>
                            <div id="b-hero-buss">
                                <div class="buss-button button l-grey"><a href="{{$posts->buss_dir}}">{{ __('messages.show_on_maps') }}</a></div>
                                <div class="buss-button-o button red"><a href="#main-posts-container">{{ __('messages.view_deal') }}</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col2">
          ...
          <dealsubmit-component buylimits ="{{$buylimits}}" postdata="{{$posts}}" descuento="{{abs(round((($posts->price_new/$posts->price_from)*100)-100))}}" userdata="{{$userdata}}">
                    ...
                    <div id="principal-small" style="display: none;" class="cupon-std-small-vertical">
                        <div class="cupon-col1-small-vertical">
                            <div style="text-transform:uppercase">{{ __('messages.valid_once') }}</div>
                        </div>
                        ...
                        <div class="cupon-col3-small-vertical">
                            ...
                            <button class="cupon-boton-small-vertical button red modaltrigger">
                                    ...
                                    <div class="loader-small-container">
                                            <div class="loader-small loaderwhite" style="font-size: 2px;">{{ __('messages.loading') }}...</div>
                                    </div>
    
                                    <span class="span-load" style="display:none; text-transform:uppercase">{{ __('messages.take_offer') }}</span>

                            </button>
                
                            <div class="cupon-descuento-small-vertical">
                                <span class="s-porcentaje-small-vertical" style="text-transform:uppercase">{{ __('messages.save_money') }}!</span>
                    ...
                    <div id="principal-std" class="cupon-std" style="display: flex; transform: scale(1);">
                        ...
                        <div class="cupon-col3">
                            <div class="cupon-descuento">
                                ...
                                <span class="s-porcentaje" style="text-transform:uppercase">{{ __('messages.save_money') }}!</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <h3 style="margin-top:56px!important;">{{ __('messages.related_offers') }}</h3>
                    </div>
